...
def load_amazon(source_name, target_name, data_folder=None, verbose=False):
    """
    Load the amazon sentiment datasets from ??? format files
    inputs:
    ...
    if data_folder is None:
        data_folder = 'data/'
    # https://blog.csdn.net/thither_shore/article/details/53027657
...
if __name__ == '__main__':
    ...
    if msda:
        ...
        try:
            ...
            xs_msda, xt_msda, xtest_msda = mSDA.compute_msda_representation(xs, xt, xtest)
